...
// import {HighchartsChart,Chart,Title,Tooltip,Subtitle,Legend,XAxis,YAxis,AreaSeries,Annotation}from 'highcharts';
import ReactHighcharts from'react-highcharts';
import RadialChart from './RadialChart';
import SimpleGraph from './SimpleGraph';
import ContributionRiskGraph from './ContributionRiskGraph';
...
class Graphs extends Component{
    ...
    render(){
        ...
        return(
          <React.Fragment>
            <Row>
              <Col sm={4}><ReactHighcharts config={config} ref="chart"></ReactHighcharts>;</Col>
              <Col sm={4}> <RadialChart /></Col>
              <Col sm={4}><SimpleGraph /></Col>
            </Row>
